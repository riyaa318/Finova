...
export default function SettingsPage() {
  ...
  return (
    <div className="page-container">
      <PageHeader
        title="Settings"
        description="Manage your account, alerts, appearance and preferences."
      />
      <div className="grid gap-5 lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-8">
        <div
          ...
          className="scrollbar-thin -mx-4 flex gap-1 overflow-x-auto px-4 pb-1 lg:sticky lg:top-24 lg:mx-0 lg:h-fit lg:flex-col lg:overflow-visible lg:px-0 lg:pb-0"
        >
