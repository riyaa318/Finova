...
export default function NotFoundPage() {
  ...
  return (
    <div className="page-container">
      <div ref={ref} className="card mx-auto mt-6 flex max-w-xl flex-col items-center px-6 py-16 text-center">
        ...
        <p className="mt-2 max-w-sm break-all text-body text-muted">
          <span className="font-semibold text-ink">{pathname}</span> is not part of FINOVA. It may have moved, or the link is mistyped.
        </p>
