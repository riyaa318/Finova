...
/** Parses YYYY-MM-DD as a *local* date (avoids the UTC off-by-one of new Date('2026-01-01')). */
...
export const diffInDays = (from, to) => Math.round((startOfDay(to) - startOfDay(from)) / MS_PER_DAY);
...
/** Local wall-clock timestamp (YYYY-MM-DDTHH:mm:ss) - comparable with other local timestamps. */
