...
const CONFIRMS = {
  reset: {
    ...
    message:
      "Your transactions, budgets, goals and notifications are replaced with the original sample data.",
  ...
  clear: {
    ...
    message:
      "Every transaction, budget, goal and notification is deleted from this browser. This cannot be undone.",
...
export default function AccountSection() {
  ...
  return (
    <div className="space-y-4">
      <SettingsSection
        title="Account"
        description="The email and name attached to this workspace."
      >
      ...
      <SettingsSection
        title="Your data"
        description="Everything is stored in this browser only. Nothing is sent to a server."
      >
        <div className="flex flex-wrap gap-2">
