...
/** Tinted square chip with the category's glyph; colour comes from the chart palette tokens. */
export default function CategoryIcon({ category, size = 36 }) {
  ...
  return (
    <span
      aria-hidden="true"
      style={{ width: size, height: size, color, backgroundColor: chartColorAlpha(meta.chart, 0.14) }}
