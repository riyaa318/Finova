...
export default function AmountText({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 font-semibold tabular-nums ${income ? "text-success" : "text-ink"} ${transaction.status === "failed" ? "line-through opacity-60" : ""} ${className}`}
    >
